...
conn = MySQLdb.connect(host='localhost',user='anu',passwd = '',port = 8080,db="car_rental") #enter Database username and password of mysql here
cursor = conn.cursor()
